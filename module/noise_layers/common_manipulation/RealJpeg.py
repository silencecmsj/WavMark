...
class JpegTest(nn.Module):
	def __init__(self, args, Q, subsample=2, path="temp/"):
...
class RealJpeg(JpegBasic):
	def __init__(self, subsample=2, differentiable=True):
		super(RealJpeg, self).__init__()

		# quantization table
		self.Q = np.random.randint(75, 92)
